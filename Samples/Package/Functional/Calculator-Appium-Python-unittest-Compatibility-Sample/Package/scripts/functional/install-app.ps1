...
# The script in functional test is used to install application
...
$arguments = "Get-AppxPackage -Name *calculator* | Remove-AppxPackage"
Start-Process powershell.exe $arguments -wait -passthru -NoNewWindow
